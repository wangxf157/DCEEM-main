...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--datarootValTarget', required=True, help='path to validation real images (should have subfolders trainA, trainB, valA, valB, etc)')
		self.parser.add_argument('--datarootValData', required=True, help='path to validation images')
		...
		# 模型参数 introAE,vqgan
		self.parser.add_argument('--which_model_netG', type=str, default='introAE', help='selects model to use for netG')
		...
		self.parser.add_argument('--dataset_mode', type=str, default='single', help='chooses how datasets are loaded. [single]')
		# train为content_gan, test为test
		self.parser.add_argument('--model', type=str, default='train', help='chooses which model to use. pix2pix, test, content_gan')
		...
		self.parser.add_argument('--channels', default="64, 128, 256, 512, 512", type=str, help='the list of channel numbers')
		self.parser.add_argument("--hdim", type=int, default=512, help="dim of the latent code, Default=512")
		self.parser.add_argument('--input_height', type=int, default=96, help='the height  of the input image to network')
		self.parser.add_argument('--input_width', type=int, default=None, help='the width  of the input image to network')
		self.parser.add_argument('--output_height', type=int, default=96, help='the height  of the output image to network')
		...
		# VQ-GAN specific parameters
		self.parser.add_argument("--lambda_adv", type=float, default=0.5,
								 help="weight for adversarial loss in VQ-GAN, Default=1.0")
		self.parser.add_argument("--lambda_recon", type=float, default=50.0,
								 help="weight for reconstruction loss in VQ-GAN, Default=1.0")
		self.parser.add_argument("--lambda_vq", type=float, default=0.1,
								 help="weight for vector quantization loss in VQ-GAN, Default=1.0")
		self.parser.add_argument("--discriminator_channels", default="64, 128, 256, 512, 512", type=str,
								 help='the list of discriminator channel numbers for VQ-GAN')
