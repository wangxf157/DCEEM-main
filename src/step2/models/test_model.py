...
class TestModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        if opt.which_model_netG == 'introAE':
            ...
            self.encoder2 =EnhancedIntroAEEncoder(norm=opt.norm, cdim=3, hdim=opt.hdim, channels=str_to_list(opt.channels),
    ...
    def test(self):
        ...
        if self.opt.which_model_netG == 'introAE':
            ...
            #self.latent_f, self.latent_i = self.encoder2(self.real_A)
            loss_vq2, self.latent_f, perplexity, encodings = self.encoder2(self.real_A)
