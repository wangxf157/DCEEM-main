...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--datarootValTarget',help='path to validation real images (should have subfolders trainA, trainB, valA, valB, etc)')
		self.parser.add_argument('--datarootValData', help='path to validation images')
		...
		self.parser.add_argument('--name', type=str, default='step2_stl10', help='name of the experiment. It decides where to store samples and models')
		...
		self.parser.add_argument('--which_data', type=str, default='./checkpoints', help='set the kind of data, with 3 choices: MNIST, chaomo, anime')
		self.parser.add_argument('--which_ep', type=str, default='10', help='the epoch of AE model used in OT')
